...
DocumentReference? get currentUserReference => currentUser?.user != null
    ? CollectionUsersRecord.collection.doc(currentUser!.user!.uid)
    : null;

CollectionUsersRecord? currentUserDocument;
final authenticatedUserStream = FirebaseAuth.instance
    ...
    .switchMap(
      (uid) => uid.isEmpty
          ? Stream.value(null)
          : CollectionUsersRecord.getDocument(
                  CollectionUsersRecord.collection.doc(uid))
              .handleError((_) {}),
    )
